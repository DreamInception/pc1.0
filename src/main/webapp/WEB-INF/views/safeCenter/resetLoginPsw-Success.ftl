...
<article id="main" class="mid-Container f-index-dline f-cb">
    ...
    <section class="user-detail f-fl">
        <div class="rlp-success-content">
            <img class="user-rlp-img" src="${base}/static/Public/images/success_Big.png">

            <p class="rlp-success-title">登录密码修改成功！</p>

            <p class="rlp-return"><span id="rtp-usetime" class="rtp-usetime">3</span>秒跳转至<a href="${base}/pcclient/resetPsw/resetPwdSuccessPage"
                                                                                            class="user-rlp-link">登录页面</a>
            </p>
        </div>
    </section>
</article>
        ...
        var timer = setInterval(function () {
            ...
            if (seconds == 0) {
                ...
                window.location.href = base
								+ "/pcclient/resetPsw/resetPwdSuccessPage";
            }
        }, 1000);
    })
</script>
